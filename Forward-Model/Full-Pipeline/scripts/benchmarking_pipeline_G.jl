...
p2 = plot(energies, cs_νe_CC,     label=L"$\nu_e$ CC", xaxis=:log,
          xlabel="E/GeV", ylabel="(σ/E) 10^{-42} m^2/Gev")
plot!(p2, energies, cs_νμ_CC,     label=L"$\nu_\mu$ CC")
plot!(p2, energies, cs_ντ_CC,     label=L"$\nu_\tau$ CC")
plot!(p2, energies, cs_antiνe_CC, label=L"$\bar{\nu}_e$ CC")
plot!(p2, energies, cs_antiνμ_CC, label=L"$\bar{\nu}_\mu$ CC")
plot!(p2, energies, cs_antiντ_CC, label=L"$\bar{\nu}_\tau$ CC")
